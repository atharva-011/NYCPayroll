...
ggplot(data = boroughs_sf) +
  geom_sf(aes(fill = Total.Daily.Salary), color = "white", size = 0.2) +
  geom_sf_text(data = boroughs_centroids, aes(label = name), check_overlap = TRUE, size = 3, colour = "firebrick") +
...
nyc_payroll_filtered$Salary.Color <- ifelse(nyc_payroll_filtered$Base.Salary < 85000, "green", "red")
...
ggplot(alluvial_data,
    ...
    labs(title = "Variation of Leave Status and Pay Basis by Boroughs",
